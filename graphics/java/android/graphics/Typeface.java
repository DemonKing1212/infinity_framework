...
public class Typeface {
    ...
    private static void updateFontOverrides(String fontPrefix, Map<String, String> fontFamilies, Map<String, Typeface> typefaces) {
        ...
        if (!familyName.equals(fontPrefix)) {
            putIfAbsent(fontPrefix, typefaces.get("default"));
            putIfAbsent(fontPrefix + "-flex", typefaces.get("default"));
            putIfAbsent(fontPrefix + "-text", typefaces.get("default"));
            putIfAbsent(fontPrefix + "-thin", create(typefaces.get("default"), 100, false));
            putIfAbsent(fontPrefix + "-light", create(typefaces.get("light"), 300, false));
            putIfAbsent(fontPrefix + "-book", create(typefaces.get("default"), 400, false));
            putIfAbsent(fontPrefix + "-regular", create(typefaces.get("regular"), 400, false));
            putIfAbsent(fontPrefix + "-text-medium", create(typefaces.get("medium"), 500, false));
            putIfAbsent(fontPrefix + "-text-medium-compat", create(typefaces.get("medium"), 500, false));
            putIfAbsent(fontPrefix + "-medium", create(typefaces.get("medium"), 500, false));
            putIfAbsent(fontPrefix + "-bold", create(typefaces.get("headline"), 700, false));
            putIfAbsent(fontPrefix + "-text-bold", create(typefaces.get("headline"), 700, false));
            putIfAbsent(fontPrefix + "-black", create(typefaces.get("headlineMedium"), 900, false));
            putIfAbsent(fontPrefix + "-condensed", typefaces.get("default"));
            putIfAbsent(fontPrefix + "-condensed-light", create(typefaces.get("default"), 300, false));
            putIfAbsent(fontPrefix + "-condensed-medium", create(typefaces.get("default"), 500, false));
        }
    }
