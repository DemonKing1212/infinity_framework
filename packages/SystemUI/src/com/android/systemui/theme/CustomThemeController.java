...
public class CustomThemeController {
    ...
    public CustomThemeController(Context context, Handler backgroundHandler) {
    ...
    public void observeSettings(Runnable reevaluateSystemThemeCallback) {
        observeSettingsKeys(CustomSettingsConstants.SYSTEM_SETTINGS_KEYS, reevaluateSystemThemeCallback, TYPE_SYSTEM);
        observeSettingsKeys(CustomSettingsConstants.SECURE_SETTINGS_KEYS, reevaluateSystemThemeCallback, TYPE_SECURE);
        observeSettingsKeys(CustomSettingsConstants.SYSTEM_SETTINGS_NOTIFY_ONLY_KEYS, null, TYPE_SYSTEM);
        observeSettingsKeys(CustomSettingsConstants.SECURE_SETTINGS_NOTIFY_ONLY_KEYS, null, TYPE_SECURE);
        observeRestartKey();
    }
